...
export default function HotVinylsPage() {
  ...
  useEffect(() => {
    ...
    getProductsWithImages().then(all =>
      setProducts(all.filter(p => p.vinilNuevo && p.vinilosenVista))
    );
  }, []);
